...
module.exports = async function getSelects(filtersObj) {
  try {
    ...
    if (filtersObj.collection === 'shoes') order = [/^36$/, /^36.5$/, /^37$/, /^37.5$/, /^38$/, /^38.5$/, /^39$/, /^39.5$/, /^40$/, /^40.5$/, /^41$/, /^41.5$/, /^42$/, /^42.5$/, /^43$/, /^43.5$/, /^44$/, /^44.5$/, /^45$/, /^45.5$/, /^46$/, /^46.5$/, /^47$/, /^47.5$/, /^48$/, /^48.5$/, /^49$/, /^49.5$/, /^50$/ ]
